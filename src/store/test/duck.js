...
export const FETCH_EXAMPLE = 'test/test/FETCH_EXAMPLE'
export const FETCH_EXAMPLE_SUCCESS = 'test/test/FETCH_EXAMPLE_SUCCESS'
export const FETCH_EXAMPLE_ERROR = 'test/test/FETCH_EXAMPLE_ERROR'
